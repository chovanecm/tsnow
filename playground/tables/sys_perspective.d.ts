declare interface sys_perspective {
      application: GlideElement<sys_perspective, glideElementType.defaultType>;
applications: GlideElement<sys_perspective, glideElementType.defaultType>;
name: GlideElement<sys_perspective, glideElementType.defaultType>;
order: GlideElement<sys_perspective, glideElementType.defaultType>;
roles: GlideElement<sys_perspective, glideElementType.defaultType>;
sys_id: GlideElement<sys_perspective, glideElementType.defaultType>;
sys_class_name: GlideElement<sys_perspective, glideElementType.defaultType>;
sys_created_by: GlideElement<sys_perspective, glideElementType.defaultType>;
sys_created_on: GlideElement<sys_perspective, glideElementType.g_glide_date_time>;
sys_mod_count: GlideElement<sys_perspective, glideElementType.defaultType>;
sys_name: GlideElement<sys_perspective, glideElementType.defaultType>;
sys_package: GlideElement<sys_perspective, glideElementType.g_reference<sys_package>>;
sys_policy: GlideElement<sys_perspective, glideElementType.defaultType>;
sys_scope: GlideElement<sys_perspective, glideElementType.g_reference<sys_scope>>;
sys_updated_by: GlideElement<sys_perspective, glideElementType.defaultType>;
sys_updated_on: GlideElement<sys_perspective, glideElementType.g_glide_date_time>;
sys_update_name: GlideElement<sys_perspective, glideElementType.defaultType>;
