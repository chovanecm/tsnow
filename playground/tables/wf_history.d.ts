declare interface wf_history {
      activity: GlideElement<wf_history, glideElementType.g_reference<wf_activity>>;
activity_index: GlideElement<wf_history, glideElementType.defaultType>;
context: GlideElement<wf_history, glideElementType.g_reference<wf_context>>;
due: GlideElement<wf_history, glideElementType.g_glide_date_time>;
ended: GlideElement<wf_history, glideElementType.g_glide_date_time>;
fault_description: GlideElement<wf_history, glideElementType.defaultType>;
input_data: GlideElement<wf_history, glideElementType.defaultType>;
is_parent: GlideElement<wf_history, glideElementType.g_boolean>;
output: GlideElement<wf_history, glideElementType.defaultType>;
output_data: GlideElement<wf_history, glideElementType.defaultType>;
parent: GlideElement<wf_history, glideElementType.g_reference<wf_executing>>;
result: GlideElement<wf_history, glideElementType.defaultType>;
rolled_back_by: GlideElement<wf_history, glideElementType.defaultType>;
started: GlideElement<wf_history, glideElementType.g_glide_date_time>;
state: GlideElement<wf_history, glideElementType.defaultType>;
sys_created_by: GlideElement<wf_history, glideElementType.defaultType>;
sys_created_on: GlideElement<wf_history, glideElementType.g_glide_date_time>;
sys_domain: GlideElement<wf_history, glideElementType.defaultType>;
sys_domain_path: GlideElement<wf_history, glideElementType.defaultType>;
sys_id: GlideElement<wf_history, glideElementType.defaultType>;
sys_mod_count: GlideElement<wf_history, glideElementType.defaultType>;
sys_updated_by: GlideElement<wf_history, glideElementType.defaultType>;
sys_updated_on: GlideElement<wf_history, glideElementType.g_glide_date_time>;
workflow_version: GlideElement<wf_history, glideElementType.g_reference<wf_workflow_version>>;
