declare interface asmt_signature {
      assertion: GlideElement<asmt_signature, glideElementType.defaultType>;
name: GlideElement<asmt_signature, glideElementType.defaultType>;
sys_id: GlideElement<asmt_signature, glideElementType.defaultType>;
type: GlideElement<asmt_signature, glideElementType.g_choice<string>>;
sys_class_name: GlideElement<asmt_signature, glideElementType.defaultType>;
sys_created_by: GlideElement<asmt_signature, glideElementType.defaultType>;
sys_created_on: GlideElement<asmt_signature, glideElementType.g_glide_date_time>;
sys_mod_count: GlideElement<asmt_signature, glideElementType.defaultType>;
sys_name: GlideElement<asmt_signature, glideElementType.defaultType>;
sys_package: GlideElement<asmt_signature, glideElementType.g_reference<sys_package>>;
sys_policy: GlideElement<asmt_signature, glideElementType.defaultType>;
sys_scope: GlideElement<asmt_signature, glideElementType.g_reference<sys_scope>>;
sys_updated_by: GlideElement<asmt_signature, glideElementType.defaultType>;
sys_updated_on: GlideElement<asmt_signature, glideElementType.g_glide_date_time>;
sys_update_name: GlideElement<asmt_signature, glideElementType.defaultType>;
