declare interface cmn_relative_duration {
      active: GlideElement<cmn_relative_duration, glideElementType.g_boolean>;
name: GlideElement<cmn_relative_duration, glideElementType.defaultType>;
script: GlideElement<cmn_relative_duration, glideElementType.defaultType>;
sys_id: GlideElement<cmn_relative_duration, glideElementType.defaultType>;
sys_class_name: GlideElement<cmn_relative_duration, glideElementType.defaultType>;
sys_created_by: GlideElement<cmn_relative_duration, glideElementType.defaultType>;
sys_created_on: GlideElement<cmn_relative_duration, glideElementType.g_glide_date_time>;
sys_mod_count: GlideElement<cmn_relative_duration, glideElementType.defaultType>;
sys_name: GlideElement<cmn_relative_duration, glideElementType.defaultType>;
sys_package: GlideElement<cmn_relative_duration, glideElementType.g_reference<sys_package>>;
sys_policy: GlideElement<cmn_relative_duration, glideElementType.defaultType>;
sys_scope: GlideElement<cmn_relative_duration, glideElementType.g_reference<sys_scope>>;
sys_updated_by: GlideElement<cmn_relative_duration, glideElementType.defaultType>;
sys_updated_on: GlideElement<cmn_relative_duration, glideElementType.g_glide_date_time>;
sys_update_name: GlideElement<cmn_relative_duration, glideElementType.defaultType>;
