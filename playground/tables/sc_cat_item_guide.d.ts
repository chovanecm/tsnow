declare interface sc_cat_item_guide {
      cascade: GlideElement<sc_cat_item_guide, glideElementType.g_boolean>;
include_items: GlideElement<sc_cat_item_guide, glideElementType.g_boolean>;
order_to_cart: GlideElement<sc_cat_item_guide, glideElementType.g_boolean>;
script: GlideElement<sc_cat_item_guide, glideElementType.defaultType>;
sys_id: GlideElement<sc_cat_item_guide, glideElementType.defaultType>;
two_step: GlideElement<sc_cat_item_guide, glideElementType.g_boolean>;
validator: GlideElement<sc_cat_item_guide, glideElementType.defaultType>;
active: GlideElement<sc_cat_item_guide, glideElementType.g_boolean>;
availability: GlideElement<sc_cat_item_guide, glideElementType.defaultType>;
billable: GlideElement<sc_cat_item_guide, glideElementType.g_boolean>;
category: GlideElement<sc_cat_item_guide, glideElementType.g_reference<sc_category>>;
cost: GlideElement<sc_cat_item_guide, glideElementType.defaultType>;
custom_cart: GlideElement<sc_cat_item_guide, glideElementType.g_reference<sys_ui_macro>>;
delivery_plan: GlideElement<sc_cat_item_guide, glideElementType.g_reference<sc_cat_item_delivery_plan>>;
delivery_plan_script: GlideElement<sc_cat_item_guide, glideElementType.defaultType>;
delivery_time: GlideElement<sc_cat_item_guide, glideElementType.defaultType>;
description: GlideElement<sc_cat_item_guide, glideElementType.defaultType>;
display_price_property: GlideElement<sc_cat_item_guide, glideElementType.defaultType>;
entitlement_script: GlideElement<sc_cat_item_guide, glideElementType.defaultType>;
group: GlideElement<sc_cat_item_guide, glideElementType.g_reference<sys_user_group>>;
hide_sp: GlideElement<sc_cat_item_guide, glideElementType.g_boolean>;
icon: GlideElement<sc_cat_item_guide, glideElementType.defaultType>;
ignore_price: GlideElement<sc_cat_item_guide, glideElementType.g_boolean>;
image: GlideElement<sc_cat_item_guide, glideElementType.defaultType>;
list_price: GlideElement<sc_cat_item_guide, glideElementType.g_currency>;
location: GlideElement<sc_cat_item_guide, glideElementType.g_reference<cmn_location>>;
mandatory_attachment: GlideElement<sc_cat_item_guide, glideElementType.g_boolean>;
meta: GlideElement<sc_cat_item_guide, glideElementType.defaultType>;
mobile_hide_price: GlideElement<sc_cat_item_guide, glideElementType.g_boolean>;
mobile_picture: GlideElement<sc_cat_item_guide, glideElementType.defaultType>;
mobile_picture_type: GlideElement<sc_cat_item_guide, glideElementType.defaultType>;
model: GlideElement<sc_cat_item_guide, glideElementType.g_reference<cmdb_model>>;
name: GlideElement<sc_cat_item_guide, glideElementType.defaultType>;
no_attachment_v2: GlideElement<sc_cat_item_guide, glideElementType.g_boolean>;
no_cart: GlideElement<sc_cat_item_guide, glideElementType.g_boolean>;
no_cart_v2: GlideElement<sc_cat_item_guide, glideElementType.g_boolean>;
no_delivery_time_v2: GlideElement<sc_cat_item_guide, glideElementType.g_boolean>;
no_order: GlideElement<sc_cat_item_guide, glideElementType.g_boolean>;
no_order_now: GlideElement<sc_cat_item_guide, glideElementType.g_boolean>;
no_proceed_checkout: GlideElement<sc_cat_item_guide, glideElementType.g_boolean>;
no_quantity: GlideElement<sc_cat_item_guide, glideElementType.g_boolean>;
no_quantity_v2: GlideElement<sc_cat_item_guide, glideElementType.g_boolean>;
no_search: GlideElement<sc_cat_item_guide, glideElementType.g_boolean>;
no_wishlist_v2: GlideElement<sc_cat_item_guide, glideElementType.g_boolean>;
omit_price: GlideElement<sc_cat_item_guide, glideElementType.g_boolean>;
order: GlideElement<sc_cat_item_guide, glideElementType.defaultType>;
ordered_item_link: GlideElement<sc_cat_item_guide, glideElementType.g_reference<sc_ordered_item_link>>;
picture: GlideElement<sc_cat_item_guide, glideElementType.defaultType>;
preview: GlideElement<sc_cat_item_guide, glideElementType.defaultType>;
price: GlideElement<sc_cat_item_guide, glideElementType.g_price>;
recurring_frequency: GlideElement<sc_cat_item_guide, glideElementType.g_choice<string>>;
recurring_price: GlideElement<sc_cat_item_guide, glideElementType.g_price>;
request_method: GlideElement<sc_cat_item_guide, glideElementType.defaultType>;
roles: GlideElement<sc_cat_item_guide, glideElementType.defaultType>;
sc_catalogs: GlideElement<sc_cat_item_guide, glideElementType.defaultType>;
sc_ic_item_staging: GlideElement<sc_cat_item_guide, glideElementType.g_reference<sc_ic_item_staging>>;
sc_ic_version: GlideElement<sc_cat_item_guide, glideElementType.defaultType>;
short_description: GlideElement<sc_cat_item_guide, glideElementType.defaultType>;
show_variable_help_on_load: GlideElement<sc_cat_item_guide, glideElementType.g_boolean>;
start_closed: GlideElement<sc_cat_item_guide, glideElementType.g_boolean>;
template: GlideElement<sc_cat_item_guide, glideElementType.g_reference<sys_template>>;
type: GlideElement<sc_cat_item_guide, glideElementType.defaultType>;
use_sc_layout: GlideElement<sc_cat_item_guide, glideElementType.g_boolean>;
vendor: GlideElement<sc_cat_item_guide, glideElementType.g_reference<core_company>>;
visible_bundle: GlideElement<sc_cat_item_guide, glideElementType.g_boolean>;
visible_guide: GlideElement<sc_cat_item_guide, glideElementType.g_boolean>;
visible_standalone: GlideElement<sc_cat_item_guide, glideElementType.g_boolean>;
workflow: GlideElement<sc_cat_item_guide, glideElementType.g_reference<wf_workflow>>;
sys_class_name: GlideElement<sc_cat_item_guide, glideElementType.defaultType>;
sys_created_by: GlideElement<sc_cat_item_guide, glideElementType.defaultType>;
sys_created_on: GlideElement<sc_cat_item_guide, glideElementType.g_glide_date_time>;
sys_mod_count: GlideElement<sc_cat_item_guide, glideElementType.defaultType>;
sys_name: GlideElement<sc_cat_item_guide, glideElementType.defaultType>;
sys_package: GlideElement<sc_cat_item_guide, glideElementType.g_reference<sys_package>>;
sys_policy: GlideElement<sc_cat_item_guide, glideElementType.defaultType>;
sys_scope: GlideElement<sc_cat_item_guide, glideElementType.g_reference<sys_scope>>;
sys_updated_by: GlideElement<sc_cat_item_guide, glideElementType.defaultType>;
sys_updated_on: GlideElement<sc_cat_item_guide, glideElementType.g_glide_date_time>;
sys_update_name: GlideElement<sc_cat_item_guide, glideElementType.defaultType>;
