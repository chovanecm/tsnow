declare interface sys_auth_profile {
      name: GlideElement<sys_auth_profile, glideElementType.defaultType>;
sys_id: GlideElement<sys_auth_profile, glideElementType.defaultType>;
sys_class_name: GlideElement<sys_auth_profile, glideElementType.defaultType>;
sys_created_by: GlideElement<sys_auth_profile, glideElementType.defaultType>;
sys_created_on: GlideElement<sys_auth_profile, glideElementType.g_glide_date_time>;
sys_mod_count: GlideElement<sys_auth_profile, glideElementType.defaultType>;
sys_name: GlideElement<sys_auth_profile, glideElementType.defaultType>;
sys_package: GlideElement<sys_auth_profile, glideElementType.g_reference<sys_package>>;
sys_policy: GlideElement<sys_auth_profile, glideElementType.defaultType>;
sys_scope: GlideElement<sys_auth_profile, glideElementType.g_reference<sys_scope>>;
sys_updated_by: GlideElement<sys_auth_profile, glideElementType.defaultType>;
sys_updated_on: GlideElement<sys_auth_profile, glideElementType.g_glide_date_time>;
sys_update_name: GlideElement<sys_auth_profile, glideElementType.defaultType>;
