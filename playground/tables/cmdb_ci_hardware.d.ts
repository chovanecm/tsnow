declare interface cmdb_ci_hardware {
      asset: GlideElement<cmdb_ci_hardware, glideElementType.g_reference<alm_asset>>;
asset_tag: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
assigned: GlideElement<cmdb_ci_hardware, glideElementType.g_glide_date_time>;
assigned_to: GlideElement<cmdb_ci_hardware, glideElementType.g_reference<sys_user>>;
assignment_group: GlideElement<cmdb_ci_hardware, glideElementType.g_reference<sys_user_group>>;
attributes: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
can_print: GlideElement<cmdb_ci_hardware, glideElementType.g_boolean>;
category: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
change_control: GlideElement<cmdb_ci_hardware, glideElementType.g_reference<sys_user_group>>;
checked_in: GlideElement<cmdb_ci_hardware, glideElementType.g_glide_date_time>;
checked_out: GlideElement<cmdb_ci_hardware, glideElementType.g_glide_date_time>;
comments: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
company: GlideElement<cmdb_ci_hardware, glideElementType.g_reference<core_company>>;
correlation_id: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
cost: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
cost_cc: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
cost_center: GlideElement<cmdb_ci_hardware, glideElementType.g_reference<cmn_cost_center>>;
default_gateway: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
delivery_date: GlideElement<cmdb_ci_hardware, glideElementType.g_glide_date_time>;
department: GlideElement<cmdb_ci_hardware, glideElementType.g_reference<cmn_department>>;
discovery_source: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
dns_domain: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
due: GlideElement<cmdb_ci_hardware, glideElementType.g_glide_date_time>;
due_in: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
duplicate_of: GlideElement<cmdb_ci_hardware, glideElementType.g_reference<cmdb_ci>>;
fault_count: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
first_discovered: GlideElement<cmdb_ci_hardware, glideElementType.g_glide_date_time>;
fqdn: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
gl_account: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
hardware_status: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
hardware_substatus: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
install_date: GlideElement<cmdb_ci_hardware, glideElementType.g_glide_date_time>;
install_status: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
invoice_number: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
ip_address: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
justification: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
last_discovered: GlideElement<cmdb_ci_hardware, glideElementType.g_glide_date_time>;
lease_id: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
location: GlideElement<cmdb_ci_hardware, glideElementType.g_reference<cmn_location>>;
mac_address: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
maintenance_schedule: GlideElement<cmdb_ci_hardware, glideElementType.g_reference<cmn_schedule>>;
managed_by: GlideElement<cmdb_ci_hardware, glideElementType.g_reference<sys_user>>;
manufacturer: GlideElement<cmdb_ci_hardware, glideElementType.g_reference<core_company>>;
model_id: GlideElement<cmdb_ci_hardware, glideElementType.g_reference<cmdb_model>>;
model_number: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
monitor: GlideElement<cmdb_ci_hardware, glideElementType.g_boolean>;
name: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
operational_status: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
order_date: GlideElement<cmdb_ci_hardware, glideElementType.g_glide_date_time>;
owned_by: GlideElement<cmdb_ci_hardware, glideElementType.g_reference<sys_user>>;
po_number: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
purchase_date: GlideElement<cmdb_ci_hardware, glideElementType.g_glide_date>;
schedule: GlideElement<cmdb_ci_hardware, glideElementType.g_reference<cmn_schedule>>;
serial_number: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
short_description: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
skip_sync: GlideElement<cmdb_ci_hardware, glideElementType.g_boolean>;
start_date: GlideElement<cmdb_ci_hardware, glideElementType.g_glide_date_time>;
subcategory: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
supported_by: GlideElement<cmdb_ci_hardware, glideElementType.g_reference<sys_user>>;
support_group: GlideElement<cmdb_ci_hardware, glideElementType.g_reference<sys_user_group>>;
sys_class_name: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
sys_class_path: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
sys_created_by: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
sys_created_on: GlideElement<cmdb_ci_hardware, glideElementType.g_glide_date_time>;
sys_domain: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
sys_domain_path: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
sys_id: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
sys_mod_count: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
sys_updated_by: GlideElement<cmdb_ci_hardware, glideElementType.defaultType>;
sys_updated_on: GlideElement<cmdb_ci_hardware, glideElementType.g_glide_date_time>;
unverified: GlideElement<cmdb_ci_hardware, glideElementType.g_boolean>;
vendor: GlideElement<cmdb_ci_hardware, glideElementType.g_reference<core_company>>;
warranty_expiration: GlideElement<cmdb_ci_hardware, glideElementType.g_glide_date>;
