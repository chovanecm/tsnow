declare interface sys_report {
      additional_groupby: GlideElement<sys_report, glideElementType.defaultType>;
aggregate: GlideElement<sys_report, glideElementType.defaultType>;
allow_data_label_overlap: GlideElement<sys_report, glideElementType.g_boolean>;
axis_max_color: GlideElement<sys_report, glideElementType.g_reference<sys_report_color>>;
axis_min_color: GlideElement<sys_report, glideElementType.g_reference<sys_report_color>>;
bar_unstack: GlideElement<sys_report, glideElementType.g_boolean>;
chart_background_color: GlideElement<sys_report, glideElementType.g_reference<sys_report_color>>;
chart_border_color: GlideElement<sys_report, glideElementType.g_reference<sys_report_color>>;
chart_border_radius: GlideElement<sys_report, glideElementType.defaultType>;
chart_border_width: GlideElement<sys_report, glideElementType.defaultType>;
chart_height: GlideElement<sys_report, glideElementType.defaultType>;
chart_size: GlideElement<sys_report, glideElementType.defaultType>;
chart_subtitle: GlideElement<sys_report, glideElementType.defaultType>;
chart_subtitle_color: GlideElement<sys_report, glideElementType.g_reference<sys_report_color>>;
chart_subtitle_size: GlideElement<sys_report, glideElementType.defaultType>;
chart_subtitle_style: GlideElement<sys_report, glideElementType.defaultType>;
chart_title: GlideElement<sys_report, glideElementType.defaultType>;
chart_title_color: GlideElement<sys_report, glideElementType.g_reference<sys_report_color>>;
chart_title_size: GlideElement<sys_report, glideElementType.defaultType>;
chart_title_style: GlideElement<sys_report, glideElementType.defaultType>;
chart_title_x_position: GlideElement<sys_report, glideElementType.defaultType>;
chart_title_y_position: GlideElement<sys_report, glideElementType.defaultType>;
chart_width: GlideElement<sys_report, glideElementType.defaultType>;
color: GlideElement<sys_report, glideElementType.g_reference<sys_report_color>>;
colors: GlideElement<sys_report, glideElementType.defaultType>;
color_palette: GlideElement<sys_report, glideElementType.g_reference<pa_chart_color_schemes>>;
column: GlideElement<sys_report, glideElementType.defaultType>;
compute_percent: GlideElement<sys_report, glideElementType.defaultType>;
content: GlideElement<sys_report, glideElementType.defaultType>;
created_by_user: GlideElement<sys_report, glideElementType.g_reference<sys_user>>;
custom_chart_size: GlideElement<sys_report, glideElementType.g_boolean>;
custom_chart_title_position: GlideElement<sys_report, glideElementType.g_boolean>;
custom_config: GlideElement<sys_report, glideElementType.defaultType>;
decimal_precision: GlideElement<sys_report, glideElementType.defaultType>;
description: GlideElement<sys_report, glideElementType.defaultType>;
direction: GlideElement<sys_report, glideElementType.defaultType>;
display_column_lines: GlideElement<sys_report, glideElementType.g_boolean>;
display_grid: GlideElement<sys_report, glideElementType.g_boolean>;
display_row_lines: GlideElement<sys_report, glideElementType.g_boolean>;
donut_width_percent: GlideElement<sys_report, glideElementType.defaultType>;
end_time: GlideElement<sys_report, glideElementType.defaultType>;
exp_report_attrs: GlideElement<sys_report, glideElementType.g_boolean>;
field: GlideElement<sys_report, glideElementType.defaultType>;
field_list: GlideElement<sys_report, glideElementType.defaultType>;
filter: GlideElement<sys_report, glideElementType.defaultType>;
from: GlideElement<sys_report, glideElementType.defaultType>;
funnel_neck_percent: GlideElement<sys_report, glideElementType.defaultType>;
gauge_autoscale: GlideElement<sys_report, glideElementType.g_boolean>;
group: GlideElement<sys_report, glideElementType.g_reference<sys_user_group>>;
import_table: GlideElement<sys_report, glideElementType.g_reference<sys_report_import_table>>;
interval: GlideElement<sys_report, glideElementType.defaultType>;
is_published: GlideElement<sys_report, glideElementType.g_boolean>;
is_real_time: GlideElement<sys_report, glideElementType.g_boolean>;
is_scheduled: GlideElement<sys_report, glideElementType.g_boolean>;
legend_align_columns: GlideElement<sys_report, glideElementType.g_boolean>;
legend_background_color: GlideElement<sys_report, glideElementType.g_reference<sys_report_color>>;
legend_border_color: GlideElement<sys_report, glideElementType.g_reference<sys_report_color>>;
legend_border_radius: GlideElement<sys_report, glideElementType.defaultType>;
legend_border_width: GlideElement<sys_report, glideElementType.defaultType>;
legend_horizontal_alignment: GlideElement<sys_report, glideElementType.defaultType>;
legend_items_left_align: GlideElement<sys_report, glideElementType.g_boolean>;
legend_vertical_alignment: GlideElement<sys_report, glideElementType.defaultType>;
list_ui_view: GlideElement<sys_report, glideElementType.g_reference<sys_ui_view>>;
location_field: GlideElement<sys_report, glideElementType.defaultType>;
lower_limit: GlideElement<sys_report, glideElementType.defaultType>;
map: GlideElement<sys_report, glideElementType.g_reference<sys_report_map>>;
map_source: GlideElement<sys_report, glideElementType.g_reference<sys_report_map_source>>;
orderby_list: GlideElement<sys_report, glideElementType.defaultType>;
others: GlideElement<sys_report, glideElementType.defaultType>;
other_threshold: GlideElement<sys_report, glideElementType.defaultType>;
page_hdrftr: GlideElement<sys_report, glideElementType.g_reference<sys_report_page_hdrftr>>;
pivot_expanded: GlideElement<sys_report, glideElementType.g_boolean>;
report_drilldown: GlideElement<sys_report, glideElementType.g_reference<sys_report_drill>>;
report_source: GlideElement<sys_report, glideElementType.g_reference<sys_report_source>>;
roles: GlideElement<sys_report, glideElementType.defaultType>;
row: GlideElement<sys_report, glideElementType.defaultType>;
score_color: GlideElement<sys_report, glideElementType.g_reference<sys_report_color>>;
sc_groupby_item_id: GlideElement<sys_report, glideElementType.defaultType>;
sc_groupby_variable_id: GlideElement<sys_report, glideElementType.defaultType>;
sc_stackby_item_id: GlideElement<sys_report, glideElementType.defaultType>;
sc_stackby_variable_id: GlideElement<sys_report, glideElementType.defaultType>;
series_name_text: GlideElement<sys_report, glideElementType.defaultType>;
set_color: GlideElement<sys_report, glideElementType.defaultType>;
show_chart_border: GlideElement<sys_report, glideElementType.g_boolean>;
show_chart_data_label: GlideElement<sys_report, glideElementType.g_boolean>;
show_chart_title: GlideElement<sys_report, glideElementType.defaultType>;
show_chart_total: GlideElement<sys_report, glideElementType.g_boolean>;
show_data_label_position_middle: GlideElement<sys_report, glideElementType.g_boolean>;
show_empty: GlideElement<sys_report, glideElementType.g_boolean>;
show_geographical_label: GlideElement<sys_report, glideElementType.g_boolean>;
show_legend: GlideElement<sys_report, glideElementType.g_boolean>;
show_legend_border: GlideElement<sys_report, glideElementType.g_boolean>;
show_marker: GlideElement<sys_report, glideElementType.g_boolean>;
show_zero: GlideElement<sys_report, glideElementType.g_boolean>;
source_type: GlideElement<sys_report, glideElementType.defaultType>;
start_time: GlideElement<sys_report, glideElementType.defaultType>;
style_config: GlideElement<sys_report, glideElementType.defaultType>;
sumfield: GlideElement<sys_report, glideElementType.defaultType>;
sys_id: GlideElement<sys_report, glideElementType.defaultType>;
table: GlideElement<sys_report, glideElementType.defaultType>;
title: GlideElement<sys_report, glideElementType.defaultType>;
title_horizontal_alignment: GlideElement<sys_report, glideElementType.defaultType>;
title_vertical_alignment: GlideElement<sys_report, glideElementType.defaultType>;
to: GlideElement<sys_report, glideElementType.defaultType>;
trend_field: GlideElement<sys_report, glideElementType.defaultType>;
type: GlideElement<sys_report, glideElementType.defaultType>;
upper_limit: GlideElement<sys_report, glideElementType.defaultType>;
user: GlideElement<sys_report, glideElementType.defaultType>;
use_color_heatmap: GlideElement<sys_report, glideElementType.g_boolean>;
use_null_in_trend: GlideElement<sys_report, glideElementType.g_boolean>;
x_axis_allow_decimals: GlideElement<sys_report, glideElementType.g_boolean>;
x_axis_display_grid: GlideElement<sys_report, glideElementType.g_boolean>;
x_axis_grid_color: GlideElement<sys_report, glideElementType.g_reference<sys_report_color>>;
x_axis_grid_dotted: GlideElement<sys_report, glideElementType.g_boolean>;
x_axis_grid_width: GlideElement<sys_report, glideElementType.defaultType>;
x_axis_label_bold: GlideElement<sys_report, glideElementType.g_boolean>;
x_axis_label_color: GlideElement<sys_report, glideElementType.g_reference<sys_report_color>>;
x_axis_label_size: GlideElement<sys_report, glideElementType.defaultType>;
x_axis_label_tilt: GlideElement<sys_report, glideElementType.defaultType>;
x_axis_opposite: GlideElement<sys_report, glideElementType.g_boolean>;
x_axis_title: GlideElement<sys_report, glideElementType.defaultType>;
x_axis_title_bold: GlideElement<sys_report, glideElementType.g_boolean>;
x_axis_title_color: GlideElement<sys_report, glideElementType.g_reference<sys_report_color>>;
x_axis_title_size: GlideElement<sys_report, glideElementType.defaultType>;
y_axis_allow_decimals: GlideElement<sys_report, glideElementType.g_boolean>;
y_axis_display_grid: GlideElement<sys_report, glideElementType.g_boolean>;
y_axis_from: GlideElement<sys_report, glideElementType.defaultType>;
y_axis_grid_color: GlideElement<sys_report, glideElementType.g_reference<sys_report_color>>;
y_axis_grid_dotted: GlideElement<sys_report, glideElementType.g_boolean>;
y_axis_grid_width: GlideElement<sys_report, glideElementType.defaultType>;
y_axis_label_bold: GlideElement<sys_report, glideElementType.g_boolean>;
y_axis_label_color: GlideElement<sys_report, glideElementType.g_reference<sys_report_color>>;
y_axis_label_size: GlideElement<sys_report, glideElementType.defaultType>;
y_axis_label_tilt: GlideElement<sys_report, glideElementType.defaultType>;
y_axis_opposite: GlideElement<sys_report, glideElementType.g_boolean>;
y_axis_title: GlideElement<sys_report, glideElementType.defaultType>;
y_axis_title_bold: GlideElement<sys_report, glideElementType.g_boolean>;
y_axis_title_color: GlideElement<sys_report, glideElementType.g_reference<sys_report_color>>;
y_axis_title_size: GlideElement<sys_report, glideElementType.defaultType>;
y_axis_to: GlideElement<sys_report, glideElementType.defaultType>;
sys_class_name: GlideElement<sys_report, glideElementType.defaultType>;
sys_created_by: GlideElement<sys_report, glideElementType.defaultType>;
sys_created_on: GlideElement<sys_report, glideElementType.g_glide_date_time>;
sys_mod_count: GlideElement<sys_report, glideElementType.defaultType>;
sys_name: GlideElement<sys_report, glideElementType.defaultType>;
sys_package: GlideElement<sys_report, glideElementType.g_reference<sys_package>>;
sys_policy: GlideElement<sys_report, glideElementType.defaultType>;
sys_scope: GlideElement<sys_report, glideElementType.g_reference<sys_scope>>;
sys_updated_by: GlideElement<sys_report, glideElementType.defaultType>;
sys_updated_on: GlideElement<sys_report, glideElementType.g_glide_date_time>;
sys_update_name: GlideElement<sys_report, glideElementType.defaultType>;
