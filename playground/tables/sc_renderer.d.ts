declare interface sc_renderer {
      name: GlideElement<sc_renderer, glideElementType.defaultType>;
order: GlideElement<sc_renderer, glideElementType.defaultType>;
sys_id: GlideElement<sc_renderer, glideElementType.defaultType>;
sys_class_name: GlideElement<sc_renderer, glideElementType.defaultType>;
sys_created_by: GlideElement<sc_renderer, glideElementType.defaultType>;
sys_created_on: GlideElement<sc_renderer, glideElementType.g_glide_date_time>;
sys_mod_count: GlideElement<sc_renderer, glideElementType.defaultType>;
sys_name: GlideElement<sc_renderer, glideElementType.defaultType>;
sys_package: GlideElement<sc_renderer, glideElementType.g_reference<sys_package>>;
sys_policy: GlideElement<sc_renderer, glideElementType.defaultType>;
sys_scope: GlideElement<sc_renderer, glideElementType.g_reference<sys_scope>>;
sys_updated_by: GlideElement<sc_renderer, glideElementType.defaultType>;
sys_updated_on: GlideElement<sc_renderer, glideElementType.g_glide_date_time>;
sys_update_name: GlideElement<sc_renderer, glideElementType.defaultType>;
