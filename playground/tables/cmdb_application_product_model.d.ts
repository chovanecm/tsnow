declare interface cmdb_application_product_model {
      sys_id: GlideElement<cmdb_application_product_model, glideElementType.defaultType>;
acquisition_method: GlideElement<cmdb_application_product_model, glideElementType.defaultType>;
asset_tracking_strategy: GlideElement<cmdb_application_product_model, glideElementType.defaultType>;
barcode: GlideElement<cmdb_application_product_model, glideElementType.defaultType>;
bundle: GlideElement<cmdb_application_product_model, glideElementType.g_boolean>;
certified: GlideElement<cmdb_application_product_model, glideElementType.g_boolean>;
cmdb_ci_class: GlideElement<cmdb_application_product_model, glideElementType.defaultType>;
cmdb_model_category: GlideElement<cmdb_application_product_model, glideElementType.defaultType>;
comments: GlideElement<cmdb_application_product_model, glideElementType.defaultType>;
cost: GlideElement<cmdb_application_product_model, glideElementType.g_price>;
depreciation: GlideElement<cmdb_application_product_model, glideElementType.g_reference<cmdb_depreciation>>;
description: GlideElement<cmdb_application_product_model, glideElementType.defaultType>;
display_name: GlideElement<cmdb_application_product_model, glideElementType.defaultType>;
expenditure_type: GlideElement<cmdb_application_product_model, glideElementType.defaultType>;
flow_rate: GlideElement<cmdb_application_product_model, glideElementType.defaultType>;
full_name: GlideElement<cmdb_application_product_model, glideElementType.defaultType>;
main_component: GlideElement<cmdb_application_product_model, glideElementType.g_reference<cmdb_m2m_model_component>>;
manufacturer: GlideElement<cmdb_application_product_model, glideElementType.g_reference<core_company>>;
model_number: GlideElement<cmdb_application_product_model, glideElementType.defaultType>;
name: GlideElement<cmdb_application_product_model, glideElementType.defaultType>;
owner: GlideElement<cmdb_application_product_model, glideElementType.g_reference<sys_user>>;
picture: GlideElement<cmdb_application_product_model, glideElementType.defaultType>;
power_consumption: GlideElement<cmdb_application_product_model, glideElementType.defaultType>;
product_catalog_item: GlideElement<cmdb_application_product_model, glideElementType.g_reference<sc_cat_item>>;
rack_units: GlideElement<cmdb_application_product_model, glideElementType.defaultType>;
salvage_value: GlideElement<cmdb_application_product_model, glideElementType.g_currency>;
short_description: GlideElement<cmdb_application_product_model, glideElementType.defaultType>;
sla: GlideElement<cmdb_application_product_model, glideElementType.defaultType>;
sound_power: GlideElement<cmdb_application_product_model, glideElementType.defaultType>;
status: GlideElement<cmdb_application_product_model, glideElementType.defaultType>;
sys_class_name: GlideElement<cmdb_application_product_model, glideElementType.defaultType>;
sys_created_by: GlideElement<cmdb_application_product_model, glideElementType.defaultType>;
sys_created_on: GlideElement<cmdb_application_product_model, glideElementType.g_glide_date_time>;
sys_domain: GlideElement<cmdb_application_product_model, glideElementType.defaultType>;
sys_domain_path: GlideElement<cmdb_application_product_model, glideElementType.defaultType>;
sys_mod_count: GlideElement<cmdb_application_product_model, glideElementType.defaultType>;
sys_updated_by: GlideElement<cmdb_application_product_model, glideElementType.defaultType>;
sys_updated_on: GlideElement<cmdb_application_product_model, glideElementType.g_glide_date_time>;
type: GlideElement<cmdb_application_product_model, glideElementType.defaultType>;
weight: GlideElement<cmdb_application_product_model, glideElementType.defaultType>;
