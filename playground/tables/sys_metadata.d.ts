declare interface sys_metadata {
      sys_class_name: GlideElement<sys_metadata, glideElementType.defaultType>;
sys_created_by: GlideElement<sys_metadata, glideElementType.defaultType>;
sys_created_on: GlideElement<sys_metadata, glideElementType.g_glide_date_time>;
sys_id: GlideElement<sys_metadata, glideElementType.defaultType>;
sys_mod_count: GlideElement<sys_metadata, glideElementType.defaultType>;
sys_name: GlideElement<sys_metadata, glideElementType.defaultType>;
sys_package: GlideElement<sys_metadata, glideElementType.g_reference<sys_package>>;
sys_policy: GlideElement<sys_metadata, glideElementType.defaultType>;
sys_scope: GlideElement<sys_metadata, glideElementType.g_reference<sys_scope>>;
sys_updated_by: GlideElement<sys_metadata, glideElementType.defaultType>;
sys_updated_on: GlideElement<sys_metadata, glideElementType.g_glide_date_time>;
sys_update_name: GlideElement<sys_metadata, glideElementType.defaultType>;
