declare interface wf_workflow {
      access: GlideElement<wf_workflow, glideElementType.defaultType>;
description: GlideElement<wf_workflow, glideElementType.defaultType>;
name: GlideElement<wf_workflow, glideElementType.defaultType>;
preview: GlideElement<wf_workflow, glideElementType.defaultType>;
sys_domain: GlideElement<wf_workflow, glideElementType.defaultType>;
sys_domain_path: GlideElement<wf_workflow, glideElementType.defaultType>;
sys_id: GlideElement<wf_workflow, glideElementType.defaultType>;
sys_overrides: GlideElement<wf_workflow, glideElementType.g_reference<wf_workflow>>;
table: GlideElement<wf_workflow, glideElementType.defaultType>;
template: GlideElement<wf_workflow, glideElementType.g_boolean>;
sys_class_name: GlideElement<wf_workflow, glideElementType.defaultType>;
sys_created_by: GlideElement<wf_workflow, glideElementType.defaultType>;
sys_created_on: GlideElement<wf_workflow, glideElementType.g_glide_date_time>;
sys_mod_count: GlideElement<wf_workflow, glideElementType.defaultType>;
sys_name: GlideElement<wf_workflow, glideElementType.defaultType>;
sys_package: GlideElement<wf_workflow, glideElementType.g_reference<sys_package>>;
sys_policy: GlideElement<wf_workflow, glideElementType.defaultType>;
sys_scope: GlideElement<wf_workflow, glideElementType.g_reference<sys_scope>>;
sys_updated_by: GlideElement<wf_workflow, glideElementType.defaultType>;
sys_updated_on: GlideElement<wf_workflow, glideElementType.g_glide_date_time>;
sys_update_name: GlideElement<wf_workflow, glideElementType.defaultType>;
      _referenceKeys: never | {
        "sys_overrides.access": string
"sys_overrides.description": string
"sys_overrides.name": string
"sys_overrides.preview": string
