declare interface cmdb_ci_service {
      aliases: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
asset: GlideElement<cmdb_ci_service, glideElementType.g_reference<alm_asset>>;
asset_tag: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
assigned: GlideElement<cmdb_ci_service, glideElementType.g_glide_date_time>;
assigned_to: GlideElement<cmdb_ci_service, glideElementType.g_reference<sys_user>>;
assignment_group: GlideElement<cmdb_ci_service, glideElementType.g_reference<sys_user_group>>;
attributes: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
business_contact: GlideElement<cmdb_ci_service, glideElementType.g_reference<sys_user>>;
business_need: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
business_relation_manager: GlideElement<cmdb_ci_service, glideElementType.g_reference<sys_user>>;
busines_criticality: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
can_print: GlideElement<cmdb_ci_service, glideElementType.g_boolean>;
category: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
change_control: GlideElement<cmdb_ci_service, glideElementType.g_reference<sys_user_group>>;
checked_in: GlideElement<cmdb_ci_service, glideElementType.g_glide_date_time>;
checked_out: GlideElement<cmdb_ci_service, glideElementType.g_glide_date_time>;
comments: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
company: GlideElement<cmdb_ci_service, glideElementType.g_reference<core_company>>;
compatibility_dependencies: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
correlation_id: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
cost: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
cost_cc: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
cost_center: GlideElement<cmdb_ci_service, glideElementType.g_reference<cmn_cost_center>>;
delivery_date: GlideElement<cmdb_ci_service, glideElementType.g_glide_date_time>;
delivery_manager: GlideElement<cmdb_ci_service, glideElementType.g_reference<sys_user>>;
department: GlideElement<cmdb_ci_service, glideElementType.g_reference<cmn_department>>;
discovery_source: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
dns_domain: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
due: GlideElement<cmdb_ci_service, glideElementType.g_glide_date_time>;
due_in: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
duplicate_of: GlideElement<cmdb_ci_service, glideElementType.g_reference<cmdb_ci>>;
end_date: GlideElement<cmdb_ci_service, glideElementType.g_glide_date_time>;
fault_count: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
first_discovered: GlideElement<cmdb_ci_service, glideElementType.g_glide_date_time>;
fqdn: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
gl_account: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
install_date: GlideElement<cmdb_ci_service, glideElementType.g_glide_date_time>;
install_status: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
invoice_number: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
ip_address: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
justification: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
last_discovered: GlideElement<cmdb_ci_service, glideElementType.g_glide_date_time>;
last_review_date: GlideElement<cmdb_ci_service, glideElementType.g_glide_date_time>;
lease_id: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
location: GlideElement<cmdb_ci_service, glideElementType.g_reference<cmn_location>>;
mac_address: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
maintenance_schedule: GlideElement<cmdb_ci_service, glideElementType.g_reference<cmn_schedule>>;
managed_by: GlideElement<cmdb_ci_service, glideElementType.g_reference<sys_user>>;
manufacturer: GlideElement<cmdb_ci_service, glideElementType.g_reference<core_company>>;
model_id: GlideElement<cmdb_ci_service, glideElementType.g_reference<cmdb_model>>;
model_number: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
monitor: GlideElement<cmdb_ci_service, glideElementType.g_boolean>;
monitoring_requirements: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
name: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
number: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
operational_status: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
order_date: GlideElement<cmdb_ci_service, glideElementType.g_glide_date_time>;
owned_by: GlideElement<cmdb_ci_service, glideElementType.g_reference<sys_user>>;
parent: GlideElement<cmdb_ci_service, glideElementType.g_reference<cmdb_ci_service>>;
po_number: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
prerequisites: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
price_model: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
price_unit: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
purchase_date: GlideElement<cmdb_ci_service, glideElementType.g_glide_date>;
schedule: GlideElement<cmdb_ci_service, glideElementType.g_reference<cmn_schedule>>;
serial_number: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
service_classification: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
service_level_requirement: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
short_description: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
skip_sync: GlideElement<cmdb_ci_service, glideElementType.g_boolean>;
sla: GlideElement<cmdb_ci_service, glideElementType.g_reference<sla>>;
start_date: GlideElement<cmdb_ci_service, glideElementType.g_glide_date_time>;
subcategory: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
supported_by: GlideElement<cmdb_ci_service, glideElementType.g_reference<sys_user>>;
support_group: GlideElement<cmdb_ci_service, glideElementType.g_reference<sys_user_group>>;
sys_class_name: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
sys_class_path: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
sys_created_by: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
sys_created_on: GlideElement<cmdb_ci_service, glideElementType.g_glide_date_time>;
sys_domain: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
sys_domain_path: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
sys_id: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
sys_mod_count: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
sys_updated_by: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
sys_updated_on: GlideElement<cmdb_ci_service, glideElementType.g_glide_date_time>;
unit_description: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
unverified: GlideElement<cmdb_ci_service, glideElementType.g_boolean>;
used_for: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
user_group: GlideElement<cmdb_ci_service, glideElementType.g_reference<sys_user_group>>;
vendor: GlideElement<cmdb_ci_service, glideElementType.g_reference<core_company>>;
version: GlideElement<cmdb_ci_service, glideElementType.defaultType>;
warranty_expiration: GlideElement<cmdb_ci_service, glideElementType.g_glide_date>;
