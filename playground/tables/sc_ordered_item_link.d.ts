declare interface sc_ordered_item_link {
      link_text: GlideElement<sc_ordered_item_link, glideElementType.defaultType>;
link_url: GlideElement<sc_ordered_item_link, glideElementType.defaultType>;
name: GlideElement<sc_ordered_item_link, glideElementType.defaultType>;
sys_id: GlideElement<sc_ordered_item_link, glideElementType.defaultType>;
target: GlideElement<sc_ordered_item_link, glideElementType.defaultType>;
sys_class_name: GlideElement<sc_ordered_item_link, glideElementType.defaultType>;
sys_created_by: GlideElement<sc_ordered_item_link, glideElementType.defaultType>;
sys_created_on: GlideElement<sc_ordered_item_link, glideElementType.g_glide_date_time>;
sys_mod_count: GlideElement<sc_ordered_item_link, glideElementType.defaultType>;
sys_name: GlideElement<sc_ordered_item_link, glideElementType.defaultType>;
sys_package: GlideElement<sc_ordered_item_link, glideElementType.g_reference<sys_package>>;
sys_policy: GlideElement<sc_ordered_item_link, glideElementType.defaultType>;
sys_scope: GlideElement<sc_ordered_item_link, glideElementType.g_reference<sys_scope>>;
sys_updated_by: GlideElement<sc_ordered_item_link, glideElementType.defaultType>;
sys_updated_on: GlideElement<sc_ordered_item_link, glideElementType.g_glide_date_time>;
sys_update_name: GlideElement<sc_ordered_item_link, glideElementType.defaultType>;
