declare interface sysrule_escalate {
      advanced_condition: GlideElement<sysrule_escalate, glideElementType.defaultType>;
assignment_script: GlideElement<sysrule_escalate, glideElementType.defaultType>;
calendar: GlideElement<sysrule_escalate, glideElementType.g_reference<sys_calendar>>;
condition: GlideElement<sysrule_escalate, glideElementType.defaultType>;
pause_condition: GlideElement<sysrule_escalate, glideElementType.defaultType>;
reset_condition: GlideElement<sysrule_escalate, glideElementType.defaultType>;
sys_id: GlideElement<sysrule_escalate, glideElementType.defaultType>;
table: GlideElement<sysrule_escalate, glideElementType.defaultType>;
threshold: GlideElement<sysrule_escalate, glideElementType.defaultType>;
description: GlideElement<sysrule_escalate, glideElementType.defaultType>;
name: GlideElement<sysrule_escalate, glideElementType.defaultType>;
order: GlideElement<sysrule_escalate, glideElementType.defaultType>;
sys_domain: GlideElement<sysrule_escalate, glideElementType.defaultType>;
sys_domain_path: GlideElement<sysrule_escalate, glideElementType.defaultType>;
sys_overrides: GlideElement<sysrule_escalate, glideElementType.g_reference<sysrule>>;
sys_class_name: GlideElement<sysrule_escalate, glideElementType.defaultType>;
sys_created_by: GlideElement<sysrule_escalate, glideElementType.defaultType>;
sys_created_on: GlideElement<sysrule_escalate, glideElementType.g_glide_date_time>;
sys_mod_count: GlideElement<sysrule_escalate, glideElementType.defaultType>;
sys_name: GlideElement<sysrule_escalate, glideElementType.defaultType>;
sys_package: GlideElement<sysrule_escalate, glideElementType.g_reference<sys_package>>;
sys_policy: GlideElement<sysrule_escalate, glideElementType.defaultType>;
sys_scope: GlideElement<sysrule_escalate, glideElementType.g_reference<sys_scope>>;
sys_updated_by: GlideElement<sysrule_escalate, glideElementType.defaultType>;
sys_updated_on: GlideElement<sysrule_escalate, glideElementType.g_glide_date_time>;
sys_update_name: GlideElement<sysrule_escalate, glideElementType.defaultType>;
